...
export const projects = projectsList({
    ...
    travelersapi: {
        ...
        title: "Travelers API",
        body: () => <>
            An <LinkOut href="https://www.npmjs.com/">npm</LinkOut> package for creating {" "}
            bots for the game <LinkOut href="https://thetravelers.online">thetravelers.online</LinkOut>.
        </>,
